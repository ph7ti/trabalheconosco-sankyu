...
$_SG['usuario'] = 'user_cv'; // Usuário MySQL
...
$_SG['tabela'] = 'agenda'; // Nome da tabela onde os usuários são salvos
...
function validaUsuario($usuario, $senha) {
	...
	$sql = "SELECT `codigo`, `nome` FROM `".$_SG['tabela']."` WHERE ".$cS." `usuario` = '".$nusuario."' AND ".$cS." `senha` = '".$nsenha."' LIMIT 1";
